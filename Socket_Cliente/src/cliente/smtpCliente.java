...
public class smtpCliente {
    ...
    public static void main(String[] args) {
        ...
        // os: flujo de entrada para recibir la rta del servidor
        // is: flujo de salida
        Socket smtpSocket = null;
        DataOutputStream os = null;
        DataInputStream is = null;
        // Inicializar el socket cliente
        // 5500: puerto en el que el servidor funciona
        // hostname: maquina q se va a conectar
        // Try to open input and output streams
        try {
            smtpSocket = new Socket("localhost", 5500);
